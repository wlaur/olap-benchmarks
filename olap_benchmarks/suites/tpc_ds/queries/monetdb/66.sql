select
  ...
  ,sum(cast(jan_sales as double)/w_warehouse_sq_ft) as jan_sales_per_sq_foot
  ,sum(cast(feb_sales as double)/w_warehouse_sq_ft) as feb_sales_per_sq_foot
  ,sum(cast(mar_sales as double)/w_warehouse_sq_ft) as mar_sales_per_sq_foot
  ,sum(cast(apr_sales as double)/w_warehouse_sq_ft) as apr_sales_per_sq_foot
  ,sum(cast(may_sales as double)/w_warehouse_sq_ft) as may_sales_per_sq_foot
  ,sum(cast(jun_sales as double)/w_warehouse_sq_ft) as jun_sales_per_sq_foot
  ,sum(cast(jul_sales as double)/w_warehouse_sq_ft) as jul_sales_per_sq_foot
  ,sum(cast(aug_sales as double)/w_warehouse_sq_ft) as aug_sales_per_sq_foot
  ,sum(cast(sep_sales as double)/w_warehouse_sq_ft) as sep_sales_per_sq_foot
  ,sum(cast(oct_sales as double)/w_warehouse_sq_ft) as oct_sales_per_sq_foot
  ,sum(cast(nov_sales as double)/w_warehouse_sq_ft) as nov_sales_per_sq_foot
  ,sum(cast(dec_sales as double)/w_warehouse_sq_ft) as dec_sales_per_sq_foot
