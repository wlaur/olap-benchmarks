-- Adapted from the official ClickBench StarRocks schema
-- (https://github.com/ClickHouse/ClickBench/blob/main/starrocks/create.sql)
-- The DUPLICATE KEY ordering matches the ClickHouse ORDER BY for fairness.
CREATE TABLE hits
(
