...
export function MarkdownContent({ content }: MarkdownContentProps) {
  return (
    <div className="prose max-w-none prose-invert prose-headings:text-slate-50 prose-p:text-slate-300 prose-a:text-accent-400 prose-a:no-underline prose-a:hover:text-accent-300 prose-a:hover:underline prose-strong:text-slate-200 prose-code:text-accent-300 prose-th:text-slate-300 prose-td:text-slate-400 prose-hr:border-border-default">
