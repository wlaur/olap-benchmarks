...
const selectorTriggerClass =
  "inline-flex max-w-[18rem] min-w-0 items-center justify-between gap-1.5 rounded-full bg-surface-raised py-1 pr-2 pl-1.5 text-left shadow-[inset_0_0_0_1px_rgba(148,163,184,0.08)] transition outline-none hover:shadow-[inset_0_0_0_1px_rgba(148,163,184,0.18)] focus:shadow-[inset_0_0_0_1px_rgba(108,142,239,0.6)] sm:min-w-[12.5rem]"
