...
-- using NOT NULL results in 2.5x slower insert times, does not impact query performance
-- not sure if nullability is a requirement for this benchmark (e.g. Clickhouse works better with NOT NULL)
CREATE TABLE hits (
    WatchID BIGINT,
    JavaEnable SMALLINT,
    Title TEXT,
