...
Revision ID: f6676e638c5b
Revises:
Create Date: 2026-03-07 17:41:32.024782
...
def upgrade() -> None:
    ...
    op.execute("insert into results_meta (key, value) values ('schema_version', '3')")
    op.create_table(
        "run",
